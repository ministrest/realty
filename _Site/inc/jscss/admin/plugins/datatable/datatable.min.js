...
(function (h) {
    ...
    function L(a, b, c, d) {
        c = "DataTables предупреждение: " + (a ? "table id=" + a.sTableId + " - " : "") + c;
        d && (c += ". Информацию об этой ошибке вы можете найти здесь http://datatables.net/tn/" +
            d);
                ...
                for (j = t.length; g < j; g++) {
                    ...
                    if (p.nTable == this || p.nTHead.parentNode == this || p.nTFoot && p.nTFoot.parentNode == this) {
                        ...
                        if (e.bDestroy !== k ? e.bDestroy : l.bDestroy) {
                            ...
                            L(p, 0, "Не могу переинициализировать DataTable", 3);
                            return
                        }
                    }
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Показать с _START_ по _END_ из _TOTAL_ строк",
            sInfoEmpty: "0 строк",
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Нет записей, удовлетворяющих условию"
        },
